...
final class AnalyticsItem
{
    ...
    /**
     * An event's params: what the items are worth together, without delivery, as Analytics wants it.
     *
     * @param  int  $value  in grosze
    ...
    {
        return ['currency' => 'PLN', 'value' => $value / 100, ...$extra, 'items' => $items];
    }
}
